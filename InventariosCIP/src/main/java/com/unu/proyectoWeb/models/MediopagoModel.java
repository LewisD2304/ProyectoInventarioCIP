...
public class MediopagoModel extends Conexion {
	...
	public int insertarMediopago(Mediopago medio) throws SQLException {
		try {
			int filasAfectadas = 0;

			String sql = "CALL sp_insertarMediopago(?,?)";
			this.abrirConexion();
			cs = conexion.prepareCall(sql);
			cs.setString(1, medio.getNombre());
			cs.setString(2, medio.getNumerom());
