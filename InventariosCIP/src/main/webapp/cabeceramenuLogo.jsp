...
<body>
  ...
  <path
						...
						<li class="btn-group dropend me-3"><a class="btn btn-danger"
							aria-current="page" href="BienesController?op=listarConPaginacion&pagina"> <svg
